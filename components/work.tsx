...
export const WorkLeft: React.FC<WorkLeftProps> = ({ children, progress }) => {
  let translateY = Math.max(0, 50 - progress * 3 * 50);
  if (progress > 0.85) translateY = Math.max(-50, -(progress - 0.85) * 2 * 50);

  return (
    <div
      className="flex flex-col items-center justify-center text-3xl lg:text-3xl h-[30vh] lg:h-auto overflow-hidden"
...
export const WorkRight: React.FC<WorkRightProps> = ({ children, progress }) => {
